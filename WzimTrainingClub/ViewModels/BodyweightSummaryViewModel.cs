...
namespace WzimTrainingClub.ViewModels
{
    public class BodyweightSummaryViewModel
    {
        ...
        public TargetBodyweight Target { get; private set; }
        ...
        public BodyweightSummaryViewModel(IEnumerable<BodyweightRecord> AllRecords, TargetBodyweight Target)
        {
            this.Target = Target;
            ...
            MostRecentRecord = AllRecords.First();
